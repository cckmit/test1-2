...
/**
*
* @ClassName   : BtoOrdStatCdVO.java
* @Description : BTO订购状态实体类.
* @author Jia   Ming 
* @since 2019. 4. 5.
* @version 1.0
* @see
...
* 
*/
public class BtoOrdStatCdVO extends BaseVO {
...
UPDT_DT DATE    Yes     19  수정일자
	 ...
	 * 
	 */
	private static final long serialVersionUID = -101117723642048592L;
	/**
     * 공통코드
     */
    @NotBlank
    ...
    public BtoOrdStatCdVO(){}
    public BtoOrdStatCdVO(String cmmCd, String cmmCdNm, String useYn){
        this.cmmCd = cmmCd;
