...
/**
 *
 * @ClassName   : OrdTpDSVO.java
 * @Description : 订单综合现况订单类型实体类.
 * @author Jia   Ming 
 * @since 2019. 4. 5.
 * @version 1.0
 * @see
...
UPDT_DT DATE    Yes     19  수정일자
     ...
     */
	private static final long serialVersionUID = -4789325512342087214L;
    ...
    public OrderTypeVO(){}
    public OrderTypeVO(String cmmCd, String cmmCdNm, String useYn){
        this.cmmCd = cmmCd;
