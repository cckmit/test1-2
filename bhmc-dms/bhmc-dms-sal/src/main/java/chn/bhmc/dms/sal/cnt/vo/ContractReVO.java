...
public class ContractReVO extends BaseVO{
    ...
    /**
     * BM优惠券 与粉丝系统新需求 贾明2020-4-22 
     */
    private String lanBinCardNo;  //蓝缤卡券号码
    private String lanBinCardType; //卡券类型
    private String lanBinUseNotice; //使用须知
    private String lanBinCardName;   //蓝缤卡券名称
    private  Double lanBinCardAmount;    //卡券面额
    private  Double lanBinCouponDeduct ;//BM优惠券抵扣
    @JsonDeserialize(using=JsonDateDeserializer.class)
    private  Date   lanBinCardEffeDt; //有效日期
    private String couponWrite; //卡券是否已核销 Y 代表已经核销 空代表未核销
    private String couponVoid; //卡券是否已反核销 Y 代表已反销售 空代表未反核销
	...
	public Double getLanBinCouponDeduct() {
		return lanBinCouponDeduct;
	}


	public void setLanBinCouponDeduct(Double lanBinCouponDeduct) {
		this.lanBinCouponDeduct = lanBinCouponDeduct;
	}
