...
public class CustomerCareExtrTargetSearchVO extends SearchVO {
    ...
    private  String              sDlrCd;            // 딜러코드[고객케어관리]经销商管理
    private  String              sCustCareSeq;      // 고객케어일련번호高客护理编号

    private  String              sExtrDgreCnt;      // 추출차수抽取次数
    private  String              sSmsSendYn;        // SMS 전송여부是否传输
    private  String              sCallCenSendYn;    // 콜센터 전송여부呼叫中心是否传送
