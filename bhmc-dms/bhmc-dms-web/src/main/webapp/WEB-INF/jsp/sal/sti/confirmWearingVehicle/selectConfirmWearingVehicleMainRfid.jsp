        ...
        $("#btnExcelExport").kendoButton({
            click:function(e) {
                ...
                var excelParam = {
                            ...
                            //CSR 171  下载文件英文名 更改成中文 在途车入库处理 2021-1-22 sart
                             ,"fileName": "<spring:message code='sal.title.confirmWearingVehicle' />.xlsx"
                             //CSR 171  下载文件英文名 更改成中文 在途车入库处理      2021-1-22 end
