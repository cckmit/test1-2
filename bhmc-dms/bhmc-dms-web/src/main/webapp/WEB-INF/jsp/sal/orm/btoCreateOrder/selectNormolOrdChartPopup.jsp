...
$(document).ready(function() {
    ...
    //BTO订单提报 点击战略资源按钮时， SA_0454T表 USE_YN 数据为N时也展示 贾明 2018-8-16 START
     var ordTpVal = cData.sOrdTp; //当Y时，是点击了 常规资源按钮，当为N时点击了，战略资源按钮 
    //BTO订单提报 点击战略资源按钮时， SA_0454T表 USE_YN 数据为N时也展示 贾明 2018-8-16 END
    //console.log("订单类型",ordTpVal);
    ...
    $("#btnExcelExport").kendoButton({
        click:function(e) {
            ...
            //console.log("我的值",tUseYn);
            //console.log("我qq的值",ordTpVal==='N'?'':ordTpVal);
            dms.ajax.excelExport({
                "beanName":"btoCreateOrderService"
                ,"templateFile":"NormolOrdChart.xlsx"
                ,"fileName":"DownloadExcel.xlsx"
                //,"tUseYn":tUseYn
                //,"tUseYn":ordTpVal==='N'?'':ordTpVal //BTO订单提报 点击战略资源按钮时， SA_0454T表 USE_YN 数据为N时也展示 贾明 2018-8-16
                ,"tUseYn":''
                ,"strYn":strYn
                //,"sOrdYymm":ordYymm
                //,"sOrdWeek":ordWeek
             ...
             transport:{
                ...
                ,parameterMap:function(options, operation) {
                    if (operation === "read") {
                        ...
                        //params["tUseYn"] = ordTpVal==='N'?'':ordTpVal; //BTO订单提报 点击战略资源按钮时， SA_0454T表 USE_YN 数据为N时也展示 贾明 2018-8-16
                        params["tUseYn"] = '';
                        params["strYn"] = strYn;
