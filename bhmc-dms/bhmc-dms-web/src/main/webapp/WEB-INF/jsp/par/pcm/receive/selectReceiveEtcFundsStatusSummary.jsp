        ...
        $("#btnExcelExport").kendoButton({
            click:function(e){
                ...
                if(selectTabId == "REFH"){
                  ...
                  //CSR 171  下载文件英文名 更改成中文 调拨入库汇总  2021-1-22 sart
                    fileName = "<spring:message code='par.menu.grFundsSumList' />.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 调拨入库汇总   2021-1-22 end
                } else {
                    beanName = "receiveEtcService";
                    templateFile = "PartReceiveEtcFundsDetail_Tpl.xlsx";
                    //fileName = "PartReceiveEtcFundsDetail.xlsx";
                    //CSR 171  下载文件英文名 更改成中文 调拨入库汇总  2021-1-22 sart
                    fileName = "<spring:message code='par.title.grFundsSumListDetail' />.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 调拨入库汇总   2021-1-22 end
                }
