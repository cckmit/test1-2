        ...
        $("#btnExcelExport").kendoButton({
            click:function(e){
                ...
                if(selectTabId == "REBH"){
                  ...
                  //CSR 171  下载文件英文名 更改成中文 配件借进汇总  2021-1-22 sart
                    fileName = "<spring:message code='par.title.grBorrowSumList' />.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 配件借进汇总   2021-1-22 end
                } else {
                    beanName = "receiveEtcService"
                    templateFile = "PartReceiveEtcBorrowDetail_Tpl.xlsx";
                    //fileName = "PartReceiveEtcBorrowDetail.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 配件借进汇总  2021-1-22 sart
                    fileName = "<spring:message code='par.title.grBorrowSumListDetail' />.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 配件借进汇总   2021-1-22 end
                }
