    ...
    $("#btnExcelExport").kendoButton({
        click:function(e){
            ...
            if(selectTabId == "IEFH"){
                ...
                //CSR 171  下载文件英文名 更改成中文 调拨出库汇总 功能下 调拨出库汇总页卡  2021-1-22 sart
                 fileName = "<spring:message code='par.title.giFundsSumList' />.xlsx";
                //CSR 171  下载文件英文名 更改成中文 调拨出库汇总 功能下 调拨出库汇总页卡  2021-1-22 end
            } else {
                beanName = "issueEtcService";
                templateFile = "PartIssueEtcFundsDetail_Tpl.xlsx";
                //fileName = "PartIssueEtcFundsDetail.xlsx";
              //CSR 171  下载文件英文名 更改成中文 调拨出库汇总 功能下 调拨出库明细页卡  2021-1-22 sart
                fileName = "<spring:message code='par.title.giFundsSumListDetail' />.xlsx";
               //CSR 171  下载文件英文名 更改成中文 调拨出库汇总 功能下  调拨出库明细页卡 2021-1-22 end
            }
