        ...
        $("#btnExcelDownload").kendoButton({
            click: function(e){
                ...
                if(selectTabId == "stockDdlnHd"){
                    ...
                    //CSR 171  下载文件英文名 更改成中文 进销存查询 2021-1-22 sart
                    fileName = "<spring:message code='par.title.grGiSaleList' />.xlsx";
                    //CSR 171  下载文件英文名 更改成中文 进销存查询    2021-1-22 end
                } else if(selectTabId == "stockDdlnDtl") {
                    beanName = "stockDdlnService";
                    templateFile = "StockDdlnDetail_Tpl.xlsx";
                    //fileName = "StockDdlnDetail.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 进销存查询 2021-1-22 sart
                    fileName = "<spring:message code='par.title.grGiSaleList' />_<spring:message code='par.lbl.item' />.xlsx";
                    //CSR 171  下载文件英文名 更改成中文 进销存查询    2021-1-22 end
                  ...
                  //CSR 171  下载文件英文名 更改成中文 进销存查询 2021-1-22 sart
                    fileName = "<spring:message code='par.title.receiveStockReport' />.xlsx";
                  //CSR 171  下载文件英文名 更改成中文 进销存查询    2021-1-22 end
                }
