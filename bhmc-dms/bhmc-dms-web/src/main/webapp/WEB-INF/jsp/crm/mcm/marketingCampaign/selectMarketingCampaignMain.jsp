            ...
            $.ajax({
                ...
                success:function(resultCnt) {
                    ...
                    dms.ajax.excelExport({
                        ...
                        //CSR 171  下载文件英文名 更改成中文  市场活动管理 详情页下的 预算功能点 2021-1-22 sart
                        ,"fileName" :"<spring:message code='crm.lbl.budget' />.xlsx"
                        //CSR 171  下载文件英文名 更改成中文  市场活动管理 详情页下的 预算功能点  2021-1-22 end
                        ,"sMakCd":makCd
                    });
