...
<body>
        ...
        <table class="tbl_list">
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td>ping 테스트</td>
                    <td><a href="javascript:batchpingSearchTest('10.125.211.115', '5000')">배치 테스트</a></td>
                </tr>
            </tbody>
        </table>
    ...
    <script type="text/javascript">
        ...
        function batchpingSearchTest(url, time){
            $.ajax({
                url:"<c:url value='/bat/sal/cmm/batCallPingSearch.do'/>?url="+url+"&timeOut="+time,
                type:'GET',
                dataType:'json',
                contentType:'application/json',
                error:function(jqXHR,status,error) {
