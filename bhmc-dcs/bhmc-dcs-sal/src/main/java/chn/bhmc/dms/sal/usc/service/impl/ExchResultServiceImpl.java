                ...
                */
                ...
                if(list.get(i).getOcarMakerTp().getBytes("UTF-8").length > 30){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.brandGudge", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getOcarOwnerNm().getBytes("UTF-8").length > 100){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.oldCarOwnerNm", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getOcarMakerNm().getBytes("UTF-8").length > 200){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("global.lbl.brand", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
...
/*********************************************************  브랜드  validation check 완료 **************************************************/
                //VIN NO 널값체크  20201108 旧车架号取消校验
                /*if(list.get(i).getOcarVinNo()==null) {
                	list.get(i).setOcarVinNo("");
                }
              ...
              /*  if(StringUtils.isBlank(list.get(i).getOcarRcptNo())){
                ...
                if(list.get(i).getOcarRcptNo().getBytes("UTF-8").length > 20){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.usedCarBillingNo", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getNcarOwnerNm().getBytes("UTF-8").length > 100){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.newCarOwnerNm", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getSsnCrnNo().getBytes("UTF-8").length > 20){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("global.lbl.idCardNo", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
 ...
 /*********************************************************  신분증번호 validation check 완료 **************************************************/
                ...
                if(StringUtils.isBlank(list.get(i).getNcarVinNo())){
                    msg = messageSource.getMessage(
                        "global.info.required.field"				//{0}은(는) 필수 입력사항 입니다.[{0}是必输项目]
                        , new String[]{
                                messageSource.getMessage("sal.lbl.newCarVinNo", null, LocaleContextHolder.getLocale())			//신분증번호[证件号码]
                        }
                        , LocaleContextHolder.getLocale()
                    );
                ...
                if(list.get(i).getNcarVinNo().getBytes("UTF-8").length > 17){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.newCarVinNo", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getNcarCarlineCd().getBytes("UTF-8").length > 50){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("global.lbl.carLine", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getNcarGradeCd().getBytes("UTF-8").length > 30){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("global.lbl.gradeCd", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getTmrCd().getBytes("UTF-8").length > 6){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.terminal", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getPayAmt().getBytes("UTF-8").length > 10){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.imsAmt", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getMatYyMmDt().getBytes("UTF-8").length > 6){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.mayYyMmDt", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
                ...
                */
                ...
                if(list.get(i).getPayYyMmDt().getBytes("UTF-8").length > 6){
                    msg = messageSource.getMessage(
                            "sal.lbl.columnLengthChk"
                            , new String[]{
                                    messageSource.getMessage("sal.lbl.payYyMmDt", null, LocaleContextHolder.getLocale())         //구분[区分]
                            }
                            , LocaleContextHolder.getLocale()
                        );
